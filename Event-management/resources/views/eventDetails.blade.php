...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="flex flex-col md:flex-row">
        ...
        <div class="w-full md:w-1/3">
                    ...
                    <div class="flex justify-between mb-4">
                        <div class="w-1/2 pr-2">
                            ...
                            <div class="flex border rounded">
                                ...
                                <input type="text" value="1" class="w-full text-center" readonly>
                                <button class="px-3 py-1 bg-gray-100 text-gray-600">+</button>
                            </div>
                        </div>
                        <div class="w-1/2 pl-2">
                            ...
                            <div class="flex border rounded">
                                <button class="px-3 py-1 bg-gray-100 text-gray-600">-</button>
                                <input type="text" value="0" class="w-full text-center" readonly>
                                <button class="px-3 py-1 bg-gray-100 text-gray-600">+</button>
                            </div>
                        </div>
                    </div>
            ...
            <!-- Phone booking section remains unchanged -->
        </div>
    </div>
</div>
</div>
