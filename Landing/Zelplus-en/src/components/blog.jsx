...
export default function Blogs(){
    return(
        <section className="relative flex items-center justify-center md:py-24 py-16" id="blog">
        <div className=" w-5/6 relative">
            <div className="grid grid-cols-1 pb-6 text-center">
                <h3 className="font-semibold text-2xl leading-normal mb-4">Blog or News</h3>

                <p className="text-slate-400 font-lexend max-w-xl mx-auto">This is just a simple text made for this unique and awesome template, you can replace it with any text.</p>
            </div>
                    ...
                    return(
                        <div className="group relative overflow-hidden" key={index}>
                            ...
                            <div className="mt-6">
                                ...
                                <Link to="" className="title text-lg font-semibold hover:text-main duration-500 ease-in-out">{item.title}</Link>
                                <p className="text-slate-400 mt-2">{item.desc}</p>

                                <div className="mt-3">
                                    <Link to="" className="text-main">Read More <i className="mdi mdi-chevron-right align-middle"></i></Link>
                                </div>
                            </div>
                        </div>
                    )
