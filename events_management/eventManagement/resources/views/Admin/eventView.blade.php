...
<div class="bg-gradient-to-b h-96 flex items-center justify-end flex-col from-gray-900 to-gray-700 text-white py-8">
    <div class="container mx-auto px-4">
        ...
        <p class="text-lg">{{$event->location}} 
        ...
        <p class="text-right text-3xl font-bold text-blue-300">Ksh {{$event->price}}<span class="text-sm">from/per person</span></p>
    </div>
</div>
...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="text-sm mb-4">
        <span class="text-gray-500">Home / Events / {{$event->name}}</span>
    </div>
    ...
    <div class="flex flex-col md:flex-row">
        ...
        <div class="w-full md:w-2/3 pr-8">
            ...
            <h3 class="text-xl font-semibold mb-2">{{$event->description_title}}</h3>
            ...
            <h3 class="text-xl font-semibold mb-2">{{$event->date}}</h3>
        ...
        <div class="w-full md:w-1/3">
            ...
            <div class="bg-white border rounded shadow-sm">
                ...
                <div class="p-4">
                    ...
                    <div class="flex justify-between text-sm mb-2">
                        ...
                        <span id="totalAmount">1x {{$event->price}}</span>
                    </div>
                    ...
                    <button class="bg-teal-500 text-white py-2 px-4 w-full rounded mb-2">BOOK NOW</button>
            ...
            <div class="mt-8 bg-gray-100 p-4 rounded">
                <h4 class="font-bold mb-2">Need help booking?</h4>
                ...
                <a href="tel:+12345678900" class="text-blue-500 font-bold">+1 234 567 89 00</a>
            </div>
        </div>
    </div>
</div>
